...
class WelcomeView(APIView):
    def get(self,request):
        content = {'message':'Welcome to DataDisca'}
        return Response(content)

class PollsView(APIView):
    def get(self,request):
        content = {'Results':'Congratulations you are selected as one of the Team member in Data Disca'}
        return Response(content)

class RegisterView(APIView):
    def get(self,request):
        content = {'Register':'Please register here to get the link'}
        return Response(content)
